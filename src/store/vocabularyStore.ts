...
export const useVocabularyStore = create<VocabularyStore>((set) => ({
  ...
  fetchReviewItems: async (userId) => {
    ...
    try {
      ...
      console.error("[Vocabulary] Error fetching review items:", e);
    } finally {
      set({ isLoading: false });
    }
  },
  ...
  addItem: async (userId, item) => {
    try {
      ...
      console.error("[Vocabulary] Error adding item:", e);
    }
  },
  ...
  updateMastery: async (itemId, mastery) => {
    try {
      ...
      console.error("[Vocabulary] Error updating mastery:", e);
    }
  },
  ...
  deleteItem: async (itemId) => {
    try {
      ...
      console.error("[Vocabulary] Error deleting item:", e);
    }
  },
