              ...
              >
                ...
                >
                  <Text
                    style={{
                      fontSize: 18,
                      opacity: isCurrent || isPassed ? 1 : 0.4,
                    }}
                  >
                    {isPassed ? "📚" : isCurrent ? "📖" : "🔒"}
                  </Text>
...
function StatCard({ icon, value, label, sub }: any) {
  return (
    ...
    >
      ...
      <Text style={{ fontSize: 24, fontWeight: "900", color: "#1C1C1E" }}>
        {value}
      </Text>
      <Text
        style={{
...
export default function ProfileScreen() {
  ...
  if (newTrophy) {
    return (
      <TrophyUnlockedScreen trophy={newTrophy} onContinue={clearNewTrophy} />
    );
  }
    ...
    <View style={{ flex: 1, backgroundColor: BG }}>
      ...
      >
        ...
        <View style={{ flexDirection: "row", gap: 10, marginBottom: 16 }}>
          ...
          <StatCard
            icon="🔖"
            value={totalBooks - booksCompleted}
            label="Pendientes"
          />
        ...
        <View style={{ flexDirection: "column", gap: 16 }}>
          ...
          {userTrophies.length > 0 && <TrophyGrid trophies={userTrophies} />}

          {sessions.length > 0 && <RecentSessions sessions={sessions} />}

          {xpEvents.length > 0 && <XpHistory events={xpEvents} />}
        </View>
      </ScrollView>
    </View>
  );
